    ...
    @endif
      <div class="row mt-3">
          <div class="col-6 col-4 col-lg-4 mb-2">
            <button href="#" class="nav-nv text-white btn bg-primary" data-bs-toggle="modal" data-bs-target="#ModalCreate"><i class="fa fa-plus"></i> Tambah data</button>
            </div>
            <div class="col-6 col-4 col-lg-4 mb-2">
                <div class="dropdown">
        ...
        @include('page.administrator.create.FormMahasantri')
        <script>
